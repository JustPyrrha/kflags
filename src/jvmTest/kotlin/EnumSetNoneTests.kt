...
class EnumSetNoneTests {
    ...
    fun `should have no flags set`() {
        ...
        assertFalse(TestFlagByte.enumSetNone().contains(TestFlagByte.F))
        ...
        assertFalse(TestFlagUByte.enumSetNone().contains(TestFlagUByte.F))
        ...
        assertFalse(TestFlagShort.enumSetNone().contains(TestFlagShort.F))
        ...
        assertFalse(TestFlagUShort.enumSetNone().contains(TestFlagUShort.F))
        ...
        assertFalse(TestFlagInt.enumSetNone().contains(TestFlagInt.F))
        ...
        assertFalse(TestFlagUInt.enumSetNone().contains(TestFlagUInt.F))
        ...
        assertFalse(TestFlagLong.enumSetNone().contains(TestFlagLong.F))
        ...
        assertFalse(TestFlagULong.enumSetNone().contains(TestFlagULong.F))
    }
}
